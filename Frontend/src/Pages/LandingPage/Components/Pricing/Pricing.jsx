...
const Pricing = () => {
    return (
        <div href="pricing" id="pricing" className="pricing-container">
            ...
            <PricingElement animation="fade-left" delay="500" isMainElement={false} buttonMessage="€95/year" title="Pro Plan" listElements={["Unlimited projects", "Voice shop advantages", "Certified audiodescription review", "Export the finished videos in 4K"]} />
        </div>
    );
}
